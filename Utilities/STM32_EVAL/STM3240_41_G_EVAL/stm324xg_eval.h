...
#ifdef USE_RSTCTS
#define EVAL_COM1_RTS_PIN                 GPIO_Pin_14
#define EVAL_COM1_RTS_GPIO_PORT           GPIOB
#define EVAL_COM1_RTS_GPIO_CLK            RCC_AHB1Periph_GPIOB
#define EVAL_COM1_RTS_SOURCE              GPIO_PinSource14
#define EVAL_COM1_RTS_AF                  GPIO_AF_USART3
#define EVAL_COM1_CTS_PIN                 GPIO_Pin_11
#define EVAL_COM1_CTS_GPIO_PORT           GPIOD
#define EVAL_COM1_CTS_GPIO_CLK            RCC_AHB1Periph_GPIOC
#define EVAL_COM1_CTS_SOURCE              GPIO_PinSource14
